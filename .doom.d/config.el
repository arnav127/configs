...
(setq user-full-name "Arnav Dixit"
      user-mail-address "arnavdixit127@gmail.com")
...
;; accept. For example:
;;
(setq doom-font (font-spec :family "IBM Plex Mono" :size 15 :weight 'regular)
...
;; c++ compile and run mapped to F5
(defun compileandrun()
  (interactive)
  (save-buffer)
